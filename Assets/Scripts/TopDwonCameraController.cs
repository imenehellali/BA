...
namespace TopDownCameraController
{
    public class TopDwonCameraController: MonoBehaviour
    {
        #region variables
        //target transform-> player
        //player moves -> controlled by touch input
        public Transform m_target;
        public float m_height = 200f;
        [SerializeField]
        private float m_distance = 90f;
        [SerializeField]
        ...
        private void OnCameraFollow()
        {
            ...
            {
                Vector3 world_pos = (Vector3.up * m_height);
                Vector3 flat_target_pos = m_target.position;
                flat_target_pos.y = 0f;
                Vector3 final_pos = flat_target_pos + world_pos;
                ...
                transform.localRotation = Quaternion.Lerp(transform.localRotation,Quaternion.Euler(90f,0f,-rotation_fac) , m_smooth_speed*Time.deltaTime);
            }
        }
